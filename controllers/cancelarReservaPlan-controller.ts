...
const cancelarReservaPlan = async (req: Request, res: Response) => {
    try {
        ...
        const reservaCancelada = await ReservesService.cancelarReservaPlan(idReserva);
...
export default cancelarReservaPlan;
